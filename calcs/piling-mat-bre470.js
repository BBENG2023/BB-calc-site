// piling-mat-bre470.js — Piling mat / crane platform design to BRE 470
// (2004), Working platforms for tracked plant. Punching-shear-through-
// platform failure onto the subgrade, checked for both the bearing (case
// 1) and travelling (case 2) track loading conditions.

import { bearingCapacityFactors, BRE470_NGAMMA_P, BRE470_KPTAN_DELTA, interpLookup } from '../js/shared-data.js';
...
export default {
  ...
  title: 'Piling Mat / Crane Platform Design to BRE 470',
  ...
  description: 'Punching-shear check of a granular working platform over a cohesive or granular subgrade under tracked plant, for both the bearing (case 1) and travelling (case 2) load conditions, with required platform thickness where one is needed.',
  assumptions: [
  ...
  calculate: (v) => {
    ...
    cases.forEach((c) => {
      ...
      if (subgradeType === 'Cohesive') {
        ...
        // Back-calculate an equivalent cohesion for the punching term below
        // — see the 'assumptions' note on this substitution.
